...
| 7 | **`download`** — save a link or the current document into the files root via `chrome.downloads`. | "Get me all the invoices as PDFs" should end in the file browser, not in screenshots. | ☐ |
